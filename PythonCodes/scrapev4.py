...
# Step 1: Convert PDF to HTML (with cleaned text)
pdf_path = "1996.pdf"
...
# Convert extracted text into structured HTML with cleaned paragraphs
html_body = ""
...
text_lines = [clean_text(line) for line in soup.body.stripped_strings]
...
csv_output_path = "data/extracted_course_titles3.csv"
