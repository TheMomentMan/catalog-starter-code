...
# Define regex pattern for course codes (e.g., "1.00", "18.014", "1.124J", "1.1OJ", "8.981, 8.982")
...
for line in text_lines:
    ...
    if match:
        ...
        if title_text:
            # Store each code with the title
            for code in codes:
        ...
        # This line continues a course title, unless it starts with "Prereq" or contains "("
...
csv_output_path = "extracted_course_titlesfinal.csv"
